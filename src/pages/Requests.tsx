...
import { Search, Filter, MoreHorizontal, Map, ArrowUpRight, Building } from 'lucide-react';
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="md:col-span-2 h-[400px] bg-gray-100 rounded-lg flex items-center justify-center relative">
                        <div className="text-center">
                          <Map className="mx-auto h-12 w-12 text-gray-400 mb-2" />
                          <p className="text-gray-500">Competitor proximity map would appear here</p>
                        </div>
                      </div>
